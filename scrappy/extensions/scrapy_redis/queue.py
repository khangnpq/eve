...
class Base(object):
    ...
    def __init__(self, server, spider, key):
        ...
        if hasattr(spider, 'tag'):
            self.key = key % {'spider': spider.name, 'group': spider.tag or 'default'}
        else:
            self.key = key % {'spider': spider.name, 'group': 'default'}
...
class SpiderPriorityQueue(Base):
    ...
    def __init__(self, server, spider, key):
        super(SpiderPriorityQueue, self).__init__(server, spider, key)
